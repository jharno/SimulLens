...
contains
  ...
  subroutine readdm
...
#ifdef MERGED_LIST
    real, dimension(20):: reading_buffer
#endif
    ...
    do i=1,nn
       ...
       !ofile='/mnt/scratch-3week/jharno/NewLensing/LOS'//Run//'/'//trim(ifile)
...
112 close(12)
  ...
  subroutine writeps
    ...
    fn1=PS_dir//trim(LOS)//'/'//trim(zstring)//'ngpps.dat'

#ifdef TEST
    !fn1=Test_dir//'ngppow_'//RedShift//'_Run'//Run//'-'//Version//'.dat'
...
#ifdef Kaiser
    fn1=PS_dir//'z_'//Z//'/npgpow_'//RedShift//'_Run'//Run//'-'//Version//'-RSD.dat'
#endif

#ifdef RANDOM
#ifdef poisson
    fn1=PS_dir//'z_'//Z//'/npgpow_'//RedShift//'_Run'//Run//'-'//Version//'-poisson.dat'
#else
    fn1=PS_dir//'z_'//Z//'/npgpow_'//RedShift//'_Run'//Run//'-'//Version//'-RDM.dat'
#endif
#endif
...
#ifdef HALO
    fn1=PS_dir//'ngppow-10000halos-shotnoise.dat'
#else    
...
!************
    ...
    write(*,*) 'Converting to poisson'
    do i = 1,nc
       do j = 1,nc
          do k = 1,nc
             if(d(i,j,k) > 0.499) then
                d(i,j,k) = 1000.0
             else
                d(i,j,k) = 0.0
             endif
